...
people <- read.csv("fisher_crawford_people.csv", stringsAsFactors=FALSE)
marriages <- read.csv("fisher_crawford_marriages.csv", stringsAsFactors=FALSE)
births <- read.csv("fisher_crawford_births.csv", stringsAsFactors=FALSE)
